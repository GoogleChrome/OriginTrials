...
| --- | --- | --- |
| [Persistent Storage](https://developers.google.com/web/updates/2016/06/persistent-storage) | Allows web sites to make storage persistent, so it is not automatically cleared by the browser. <br> [Intent to Experiment](https://groups.google.com/a/chromium.org/d/topic/blink-dev/5Sihi1iAXYc/discussion) | First available in Chrome M52. Trial ends in October 2016. |
