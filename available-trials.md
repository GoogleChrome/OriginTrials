...
| [Web Budget API](https://developers.google.com/web/updates/2017/06/budget-api) | Allow web sites to perform limited background work without notifying the user, such as silent push or performing a background fetch. <br> [Intent to Experiment](https://groups.google.com/a/chromium.org/forum/#!topic/blink-dev/_l_fxUTWCHs/discussion) | First available in Chrome M60. Trial ends on October 17, 2017. |
| [Generic Sensors](https://github.com/intel/generic-sensor-demos) | Provides a framework that provides consistent interfaces for sensor devices exposed to the web platform. <br> [Intent to Experiment](https://groups.google.com/a/chromium.org/d/msg/blink-dev/2zPZt3watBk/M4qcI8wlBwAJ) | First available in Chrome M62. Trial ends on February 27, 2018. |
